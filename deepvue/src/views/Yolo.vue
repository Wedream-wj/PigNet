...
<!--                <el-button type="primary" @click="uploadImg">点击上传</el-button>-->
                    <el-button type="primary">
                        <a href="http://1.12.231.219:8083/results/H_000006.png" target="_blank" style="color: white;text-decoration-line: none">样例图片</a>
                    </el-button>
<!--                <el-button type="primary" style="margin-right: 0px" :href='https://github.com'>样例图片</el-button>-->
<!--                <a href="http://1.12.231.219:8083/results/H_000006.png" class="el-button el-button&#45;&#45;primary">样例图片</a>-->
