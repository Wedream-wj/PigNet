            ...
            <el-dialog title="提示" v-model="dialogVisible" width="30%">
                <el-form :model="form" label-width="120px">
                    <el-form-item label="大类">
                        <el-input v-model="form.type1" style="width: 80%;"></el-input>
                    </el-form-item>
                    <el-form-item label="小类">
                        <el-input v-model="form.type2" style="width: 80%;"></el-input>
                    </el-form-item>
                    <el-form-item label="推荐星级">
                        <el-input v-model="form.star" style="width: 80%;"></el-input>
                    </el-form-item>
    ...
    export default {
        ...
        data() {
            return {
                ...
                total: 0,
                tableData: [],
                excelDownloadUrl: "http://" + window.server.filesUploadUrl + ":9090/bookClassification/downloadExcel",
            }
        },
        ...
        methods: {
            load() {
                    request.get("/bookClassification",{
                    params: {
            ...
            save() {
                if(this.form.id) {
                    request.put("/bookClassification",this.form).then(res=>{
                        console.log(res)
                        if (res.code==='0') {
                            this.$message({
                                type: "success",
                    ...
                    request.post("/bookClassification",this.form).then(res=>{
                        console.log(res)
                        if (res.code==='0') {
                            this.$message({
                                type: "success",
            ...
            handleDelete(id) {
                console.log(id)
                request.delete("/bookClassification/"+id).then(res=> {
                    if (res.code==='0') {
                        this.$message({
                            type: "success",
                            message: "删除成功"
