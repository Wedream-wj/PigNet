        ...
        <div id="registerBox">
            ...
            <el-form ref="form" :model="form" size="normal" :rules="rules">
                ...
                <el-form-item prop="confirm">
                    <el-input class="inps" prefix-icon="el-icon-lock" v-model="form.confirm" show-password placeholder='请再次输入密码'></el-input>
                </el-form-item>
                <el-form-item prop="email">
                    <el-input class="inps" prefix-icon="el-icon-s-platform" v-model="form.email" placeholder='请输入邮箱'></el-input>
                </el-form-item>
                <el-form-item>
                    <el-button class="submitBtn" style="width: 100%" type="primary" @click="register">注 册</el-button>
                </el-form-item>
            </el-form>
        </div>
    </div>
        ...
        methods: {
            register() {
                ...
                this.$refs['form'].validate((valid)=>{
                    if(valid) {
                        request.post("/api/user/register2",this.form).then(res=> {
                            if (res.code === '0') {
                                this.$message({
                                    type: "success",
                                    message: "注册成功"
                                ...
                                this.$router.push("/register")  // 注册失败之后跳回原来网页
                            }
                        })
                    }
                })
...
<style >
    #bg {
        ...
        background-image: url("../assets/pig6.jpg");
        position: relative;}
    #registerBox {
        width: 400px;
        height: 450px;
