...
if __name__ == '__main__':
    ...
    # parser.add_argument('--weights', type=str, default=r'F:\02software\yolov5\weights\yolov5s_pig_origin.pt', help='weights path')
    parser.add_argument('--weights', type=str, default=r'F:\02software\yolov5\weights\yolov5s_pig.pt', help='weights path')
    ...
    try:
        ...
        print("before torch.onnx.export!")
