...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1000, 751)
        MainWindow.setWindowTitle("图片调整界面")
        MainWindow.setWindowIcon(QIcon('./Icons/draw.png'))
        MainWindow.setFixedSize(MainWindow.width(), MainWindow.height())
        self.centralWidget = QtWidgets.QWidget(MainWindow)
        self.centralWidget.setObjectName("centralWidget")
        self.imgBalanceWin = QtWidgets.QLabel(self.centralWidget)
        self.imgBalanceWin.setGeometry(QtCore.QRect(320, 20, 631, 621))
        self.imgBalanceWin.setText("")
        self.imgBalanceWin.setObjectName("imgBalanceWin")
        self.gridLayoutWidget = QtWidgets.QWidget(self.centralWidget)
        self.gridLayoutWidget.setGeometry(QtCore.QRect(40, 60, 232, 371))
        ...
        self.gridLayout.addWidget(self.filter_mode, 12, 0, 1, 1)
        self.filter_median = QtWidgets.QRadioButton(self.gridLayoutWidget)
        self.filter_median.setObjectName("filter_median")
        self.gridLayout.addWidget(self.filter_median, 6, 0, 1, 1)
        self.filter_max = QtWidgets.QRadioButton(self.gridLayoutWidget)
        self.filter_max.setObjectName("filter_max")
        self.gridLayout.addWidget(self.filter_max, 3, 0, 1, 1)
        self.filter_contour = QtWidgets.QRadioButton(self.gridLayoutWidget)
        self.filter_contour.setObjectName("filter_contour")
        self.gridLayout.addWidget(self.filter_contour, 2, 0, 1, 1)
        self.filter_detail = QtWidgets.QRadioButton(self.gridLayoutWidget)
        self.filter_detail.setObjectName("filter_detail")
        self.gridLayout.addWidget(self.filter_detail, 5, 0, 1, 1)
        self.filter_edge_enhance = QtWidgets.QRadioButton(self.gridLayoutWidget)
        self.filter_edge_enhance.setObjectName("filter_edge_enhance")
        self.gridLayout.addWidget(self.filter_edge_enhance, 8, 0, 1, 1)
        self.filter_smooth = QtWidgets.QRadioButton(self.gridLayoutWidget)
        self.filter_smooth.setObjectName("filter_smooth")
        self.gridLayout.addWidget(self.filter_smooth, 10, 0, 1, 1)
        self.filter_min = QtWidgets.QRadioButton(self.gridLayoutWidget)
        self.filter_min.setObjectName("filter_min")
        self.gridLayout.addWidget(self.filter_min, 4, 0, 1, 1)
        self.filter_rank = QtWidgets.QRadioButton(self.gridLayoutWidget)
        self.filter_rank.setObjectName("filter_rank")
        self.gridLayout.addWidget(self.filter_rank, 7, 0, 1, 1)
        self.filter_emboss = QtWidgets.QRadioButton(self.gridLayoutWidget)
        self.filter_emboss.setObjectName("filter_emboss")
        self.gridLayout.addWidget(self.filter_emboss, 9, 0, 1, 1)
        self.filter_blue = QtWidgets.QRadioButton(self.gridLayoutWidget)
        self.filter_blue.setObjectName("filter_blue")
        self.gridLayout.addWidget(self.filter_blue, 1, 0, 1, 1)
        self.filter_sharpen = QtWidgets.QRadioButton(self.gridLayoutWidget)
        self.filter_sharpen.setObjectName("filter_sharpen")
        self.gridLayout.addWidget(self.filter_sharpen, 11, 0, 1, 1)
        self.filter_reset = QtWidgets.QRadioButton(self.gridLayoutWidget)
        self.filter_reset.setObjectName("filter_reset")
        self.gridLayout.addWidget(self.filter_reset, 0, 0, 1, 1)
        ...
        self.GaussBlurLabel.setGeometry(QtCore.QRect(20, 530, 61, 16))
        ...
        self.GaussBlurSlider.setGeometry(QtCore.QRect(90, 530, 160, 22))
        ...
        self.origin_Btn.setGeometry(QtCore.QRect(520, 680, 93, 28))
        ...
        self.draw_Btn.setGeometry(QtCore.QRect(660, 680, 93, 28))
        self.draw_Btn.setObjectName("draw_Btn")
        self.reset_Btn = QtWidgets.QPushButton(self.centralWidget)
        self.reset_Btn.setGeometry(QtCore.QRect(380, 680, 93, 28))
        self.reset_Btn.setObjectName("reset_Btn")
        self.ok_Btn = QtWidgets.QPushButton(self.centralWidget)
        self.ok_Btn.setGeometry(QtCore.QRect(800, 680, 93, 28))
        ...
        self.GaussBlur_label.setGeometry(QtCore.QRect(270, 530, 31, 21))
        ...
        self.deColor_Btn.setGeometry(QtCore.QRect(80, 460, 51, 28))
        self.deColor_Btn.setObjectName("deColor_Btn")
        self.invertColor_Btn = QtWidgets.QPushButton(self.centralWidget)
        self.invertColor_Btn.setGeometry(QtCore.QRect(170, 460, 51, 28))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.filter_mode.setText(_translate("MainWindow", "波形滤镜 ModeFilter"))
        self.filter_median.setText(_translate("MainWindow", "中值滤波滤镜 MedianFilter"))
        self.filter_max.setText(_translate("MainWindow", "最大值滤波  MaxFilter"))
        self.filter_contour.setText(_translate("MainWindow", "轮廓滤镜 CONTOUR"))
        self.filter_detail.setText(_translate("MainWindow", "细节滤镜 DETAIL"))
        self.filter_edge_enhance.setText(_translate("MainWindow", "边界增强滤镜 EDGE_ENHANCE"))
        self.filter_smooth.setText(_translate("MainWindow", "平滑滤镜 SMOOTH"))
        self.filter_min.setText(_translate("MainWindow", "最小值滤波  MinFilter"))
        self.filter_rank.setText(_translate("MainWindow", "等级滤波 RankFilter"))
        self.filter_emboss.setText(_translate("MainWindow", "浮雕滤镜 EMBOSS"))
        self.filter_blue.setText(_translate("MainWindow", "模糊滤镜  BLUR"))
        self.filter_sharpen.setText(_translate("MainWindow", "锐化滤镜 SHARPEN"))
        self.filter_reset.setText(_translate("MainWindow", "未选择"))
        self.label.setText(_translate("MainWindow", "滤镜"))
